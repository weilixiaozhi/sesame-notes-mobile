...
// tests for PostLedgersByLedgerIdCategoriesRequest
void main() {
  final instance = PostLedgersByLedgerIdCategoriesRequestBuilder();
  // TODO add properties to the builder and call build()

  group(PostLedgersByLedgerIdCategoriesRequest, () {
    // String id
