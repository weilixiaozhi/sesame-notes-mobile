...
// tests for PostSyncPushRequestChangesInnerAnyOf2AnyOfPayload
void main() {
  final instance = PostSyncPushRequestChangesInnerAnyOf2AnyOfPayloadBuilder();
  // TODO add properties to the builder and call build()

  group(PostSyncPushRequestChangesInnerAnyOf2AnyOfPayload, () {
    // String name
