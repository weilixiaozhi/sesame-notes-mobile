...
class CategoriesApi {
  ...
  Future<Response<void>> deleteLedgersByLedgerIdCategoriesByCategoryId({
    ...
    final _path = r'/api/v1/ledgers/{ledger_id}/categories/{category_id}'
        .replaceAll(
            '{' r'ledger_id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Category>>> getLedgersByLedgerIdCategories({
    required String ledgerId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/ledgers/{ledger_id}/categories'.replaceAll(
        '{' r'ledger_id' '}',
        encodeQueryParameter(_serializers, ledgerId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Category>> patchLedgersByLedgerIdCategoriesByCategoryId({
    required String ledgerId,
    required String categoryId,
    required PatchLedgersByLedgerIdCategoriesByCategoryIdRequest
        patchLedgersByLedgerIdCategoriesByCategoryIdRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type =
          FullType(PatchLedgersByLedgerIdCategoriesByCategoryIdRequest);
  ...
  /// Returns a [Future] containing a [Response] with a [Category] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Category>> postLedgersByLedgerIdCategories({
    required String ledgerId,
    required PostLedgersByLedgerIdCategoriesRequest
        postLedgersByLedgerIdCategoriesRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(PostLedgersByLedgerIdCategoriesRequest);
      _bodyData = _serializers.serialize(postLedgersByLedgerIdCategoriesRequest,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
