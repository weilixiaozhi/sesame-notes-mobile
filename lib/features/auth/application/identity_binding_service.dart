...
///   LOCAL member、self_member_id 和历史引用一行不动（不变量 I-02/I-03）；
/// - 云账本的 REGISTERED 本人由同步/成员目录按 registeredMemberId 建立；
/// - `unbindOnLogout` 只清理由旧版本遗留的 LOCAL 绑定，作为安全兜底：只清空
///   LOCAL member 的 linked_account_id，不改 member id、display name、交易或分摊引用。
